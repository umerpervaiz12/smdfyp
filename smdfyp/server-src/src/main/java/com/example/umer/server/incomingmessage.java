...
public class incomingmessage extends Service
{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (extras != null) {
                ...
                for (int i = 0; i < smsextras.length; i++) {
                    ...
                    String newstr = "Emergency:";

                    String newstr2 = "lan:";

                    boolean checkemergency = strMsgBody.contains(newstr);
                    boolean checklocation = strMsgBody.contains(newstr2);

                    if (checkemergency && checklocation) {

                        char[] msgtype = new char[50];
                       ...
                       // Log.i(TAG, finalmsg);
                        ...
                        tableData.setphonenumber(strMsgSrc);
                        tableData.setdetails(finalmsg);
                        tableData.setlongitude(finallon);
                        tableData.setlatitude(finallan);
                        DB.addTableData(tableData);
